                ...
                {week.map((day, index) => {
                    ...
                    switch (day) {
                        case 0:
                            ...
                            return (
                                <DaySquare className={habitDays.includes(day)? "selected" : "day"} key={index}>D</DaySquare>
                                );
                        case 1:
                        case 5:
                        case 6:
                            return (
                                <DaySquare className={habitDays.includes(day)? "selected" : "day"} key={index}>S</DaySquare>
                                );
                        case 2:

                            return (
                                <DaySquare className={habitDays.includes(day)? "selected" : "day"} key={index}>T</DaySquare>
                                );
                        case 3:
                        case 4:
